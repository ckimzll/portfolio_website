  ...
  return (
    <div className={`header ${scrollPosition > 1 ? 'scrolled' : ''}${scrollPosition > screenHeight ? '2' : ''}`}>
      <a href='' className='header-left'>
        <span className='logo-chae'/>
        <span className='logo-yeon'/>
      </a>
    ...
    <div className='section6-wrap'>
      <div className='section6'>
        ...
        <motion.div 
          ...
          transition={{ duration: 1}}
        >
          <a rel="noopener noreferrer" href='https://open.kakao.com/o/sjqDOpLh' target='_blank'>
  ...
  return (
    <div className='footer'>
      ...
      <div className='footer-right'>
        Tel :  010-8296-7927 <br/>
        Email : kcy211211@naver.com <br/>
        Copyright 2025. CHAEYEON. All rights reserved.
      </div>
    </div>
  )
}
